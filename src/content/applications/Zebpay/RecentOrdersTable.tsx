...
import { dataObj, CryptoOrderStatus } from 'src/models/crypto_orderzebpay';
                 ...
                 {/* <TableCell>
                  ...
                  <TableCell>
                    <Typography
                      variant="body1"
                      fontWeight="bold"
                      color={Lastprv > dataObj.buy?"red": "green" }
                      gutterBottom
                      noWrap
                    >
                      {dataObj.market} <img style={{position:"relative",top:"4px"}} alt="logo" height='20px' width='25px' src={"/static/images/gif/"+`${dataObj.currency.toLowerCase()}`+'.png'}/>
                    </Typography>
